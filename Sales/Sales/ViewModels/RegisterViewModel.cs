...
namespace Sales.ViewModels
{
    ...
    public class RegisterViewModel : BaseViewModel
    {
        ...
        private ImageSource imageSourse;
        ...
        {
            get { return this.imageSourse; }
            set { this.SetValue(ref this.imageSourse, value); }
        }
        #endregion
